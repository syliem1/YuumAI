    ...
    <div className="flex items-center justify-center min-h-screen bg-[url('/images/classroom-background.png')] bg-cover bg-center">
      <div className="text-center">
        ...
        <div className="relative w-24 h-24 mx-auto mb-8">
          ...
          <div className="absolute inset-2 border-4 border-sky-300 border-t-sky-500 rounded-full animate-spin" style={{ animationDuration: '0.7s', animationDirection: 'reverse' }}></div>
        </div>
